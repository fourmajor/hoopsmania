# Employee Guide (Human-Readable)

Canonical source of truth: `.openclaw/employees.yaml`.

This document is a readability guide only. If this file and YAML diverge, the YAML is authoritative.

## Current Roster (aliases)
...
For full policy details, see the `policies` section in `.openclaw/employees.yaml`:
